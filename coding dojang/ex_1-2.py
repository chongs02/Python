...
#이런 상근이를 불쌍하게 보던, 창영이는 자신이 사용하는 방법을 추천해 주었다.바로 "45분 일찍 알람 맞추기"이다.
...
def alram():
    ...
    t = datetime.datetime(100,1,1,h,m,0)
    alram = t - datetime.timedelta(minutes =45)
    alram = alram.time()
    return print(alram.hour,'시', alram.minute,'에 알람이 울립니다.')
